...
BERT + ViT:
  python evaluate_breakdown.py --checkpoint checkpoint_bert_vit/bert-vit/checkpoint-1000 --config params.yaml --output_csv results_bert_vit.csv

RoBERTa + BEiT  (params.yaml must have roberta-base / beit encoder):
  python evaluate_breakdown.py --checkpoint checkpoint/roberta-beit/checkpoint-1000 --config params.yaml --output_csv results_roberta_beit.csv
"""
...
def main():
    ...
    ckpt_file = os.path.join(args.checkpoint, "pytorch_model.bin")
